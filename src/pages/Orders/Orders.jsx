        ...
        {!loading && orders.map((item, i) => {
          ...
          return (
            <div
              ...
              style={{ background: mobileCardBg || "var(--color-card-bg)", borderColor: mobileBorderSubtle }}
            >
          ...
          <div className="bg-cardBg">
            {loading && (
              <div className="animate-pulse">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr] px-4 py-3 border-b border-borderColor bg-cardBg">
